package com.notification.management.util;

public class MessageConstants {
    public static final String SUCCESS_CODE = "MGMT-000";
    public static final String GENERIC_ERROR_CODE = "MGMT-999";
    public static final String VALIDATION_ERROR_CODE = "MGMT-001";
    public static final String NOT_FOUND_CODE = "MGMT-002";
    public static final String UNAUTHORIZED_CODE = "MGMT-003";

    public static final String SUCCESS_MSG = "Management operation completed successfully";
    public static final String ERROR_MSG_GENERIC = "An unexpected error occurred in Management Service";
    public static final String INVALID_REQUEST_CODE = "MGMT-004";
